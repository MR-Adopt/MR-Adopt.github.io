...
@SmallTest
public class ArtifactAwareContextSelectorTestCase_returnsMuleLoggerContextForInternalArtifactClassLoader_GT extends AbstractMuleTestCase {
  ...
  public void returnsMuleLoggerContextForInternalArtifactClassLoader_IT() {
    ...
    List<Object> transformed_inputs = inputTransformation_returnsMuleLoggerContextForInternalArtifactClassLoader(fqcn, currentContext, systemLoader);
