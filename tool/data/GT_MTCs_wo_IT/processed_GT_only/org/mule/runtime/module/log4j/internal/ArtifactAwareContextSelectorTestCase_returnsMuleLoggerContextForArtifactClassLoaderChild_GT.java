...
@SmallTest
public class ArtifactAwareContextSelectorTestCase_returnsMuleLoggerContextForArtifactClassLoaderChild_GT extends AbstractMuleTestCase {
  ...
  public void returnsMuleLoggerContextForArtifactClassLoaderChild_IT() {
    ...
    List<Object> transformed_inputs = inputTransformation_returnsMuleLoggerContextForArtifactClassLoaderChild(fqcn, currentContext, regionClassLoader);
