 ...
 * 
 */
public class TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_GT {

	// private final static Logger logger  = Logger.getLogger(TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex.class.getName());
	...
	public void setUp() throws PluginException, ModelException {
		...
		workflowMockEnvironment.setModelPath("/bpmn/TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex.bpmn");
		...
		// logger.info("[TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex] setup test data...");
	...
	public void testCreateSubProcessCopyItemByRegex_IT() throws ModelException {
		String itemName1 = "$workitemref";
		ItemCollection documentContext = this.documentContext; documentContext.replaceItemValue("$workitemref", "11112222"); documentContext.replaceItemValue("txtworkitemref", "11112222");
		String itemName2 = inputTransformation_testCreateSubProcessCopyItemByRegex(documentContext, itemName1);
