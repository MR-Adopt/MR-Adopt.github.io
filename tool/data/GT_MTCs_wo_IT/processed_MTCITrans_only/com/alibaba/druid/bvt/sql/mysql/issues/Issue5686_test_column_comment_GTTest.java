 ...
 */
public class Issue5686_test_column_comment_GTTest {

//     @Test
//     public void test_column_comment_h() throws Exception {
...
// // 
// //         MySqlInsertStatement sqlStatement2 = (MySqlInsertStatement) SQLUtils.parseSingleStatement(sql,dbType,keepComments);
// //         sqlStatement2 = sqlStatement;
// //         return sqlStatement2;
// //     }
// // 
    @Test
    public void test_column_comment_IT() throws Exception {
        String sql = "INSERT INTO TABLE_TEST_1(\n" + "\tDATE_ID,-- qianzhushi\n" + "\tCUS_NO -- houzhushi\n,\n" + "\tCUS_NAME\n" + ")\n" + "SELECT A.DATE_ID,\n" + "\tA.CUS_NO,\n"
            + "\tA.CUS_NAME\n" + "FROM TABLE_TEST_2 \n" + "WHERE COL1='1';";
        System.out.println("原始的sql===" + sql);
        MySqlInsertStatement sqlStatement = (MySqlInsertStatement) SQLUtils.parseSingleStatement(sql,DbType.mysql,true);
        ...
        MySqlInsertStatement sqlStatement2 = Issue5686_test_column_comment_GT.inputTransformation_test_column_comment(sqlStatement);
