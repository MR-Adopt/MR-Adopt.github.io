...
public class SegmentToMoveCalculatorTest_testHalfSegmentsArePickedForMoveWhenFullSkew_GTTest
{
...
//   @Test
//   public void testHalfSegmentsArePickedForMoveWhenFullSkew_h()
//   {
//     String tier = "tier1";
...
// 
//     String tier2 = "tier1";
//     List<ServerHolder> historicals2 = Arrays.asList(
//         createServer("A", WIKI_SEGMENTS),
//         createServer("B", Collections.emptyList())
//     );
// 
...
//     
//     int segmentsToMoveToFixSkew = SegmentToMoveCalculator
...
//         .computeNumSegmentsToMoveInTier(tier2, historicals2, maxSegmentsToMoveInTier);
// 
...
// // 
  @Test
  public void testHalfSegmentsArePickedForMoveWhenFullSkew_IT()
  {
    String tier = "tier1";
    List<ServerHolder> historicals = Arrays.asList(
        createServer("A", WIKI_SEGMENTS),
    ...
    List<Object> transformed_inputs = SegmentToMoveCalculatorTest_testHalfSegmentsArePickedForMoveWhenFullSkew_GT.inputTransformation_testHalfSegmentsArePickedForMoveWhenFullSkew(tier, historicals);

    String tier2 = (String) transformed_inputs.get(0);
    List<ServerHolder> historicals2 = (List<ServerHolder>) transformed_inputs.get(1);
