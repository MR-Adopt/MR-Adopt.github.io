...
public class IsBooleanDimFilterTest_testGetCacheKey_GTTest extends InitializedNullHandlingTest
{
//   @Test
...
// // 
  ...
  {
    EqualityFilter f3 = new EqualityFilter("x", ColumnType.STRING, "hello", null);
    EqualityFilter f4 = IsBooleanDimFilterTest_testGetCacheKey_GT.inputTransformation_testGetCacheKey(f3);
