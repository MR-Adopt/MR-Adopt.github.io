...
class EtcdKeepAliveLeaseManagerTest_getOrCreateKeepAliveLeaseTest_GTTest {
...
// // 
    ...
    void getOrCreateKeepAliveLeaseTest_IT() throws Exception {
        String key1 = "/test";
        int timeToLive1 = 3;
        String key2 = EtcdKeepAliveLeaseManagerTest_getOrCreateKeepAliveLeaseTest_GT.inputTransformation_getOrCreateKeepAliveLeaseTest(key1);
        int timeToLive2 = 3;
        long first = etcdKeepAliveLeaseManager.getOrCreateKeepAliveLease(key1, timeToLive1);
        long second = etcdKeepAliveLeaseManager.getOrCreateKeepAliveLease(key2, timeToLive2);
        Assertions.assertEquals(first, second);
