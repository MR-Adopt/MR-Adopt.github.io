...
@SmallTest
public class ArtifactAwareContextSelectorTestCase_returnsMuleLoggerContextForArtifactClassLoaderChild_GTTest extends AbstractMuleTestCase {
...
//   @Test
//   public void returnsMuleLoggerContextForArtifactClassLoaderChild_h() {
...
// //     ClassLoader childClassLoader = new URLClassLoader(new URL[0], regionClassLoader);
// // 		List<Object> transformed_inputs = Arrays.asList(fqcn, childClassLoader,currentContext2);
// // 		return transformed_inputs;
// // 	}
// // 
  @Test
  public void returnsMuleLoggerContextForArtifactClassLoaderChild_IT() {
    RegionClassLoader regionClassLoader = this.regionClassLoader;
    String fqcn = "";
    boolean currentContext = true;

    List<Object> transformed_inputs = ArtifactAwareContextSelectorTestCase_returnsMuleLoggerContextForArtifactClassLoaderChild_GT.inputTransformation_returnsMuleLoggerContextForArtifactClassLoaderChild(fqcn, currentContext, regionClassLoader);
    String fqcn2 = (String) transformed_inputs.get(0);
    boolean currentContext2 = (boolean) transformed_inputs.get(2);
    ClassLoader childClassLoader = (ClassLoader) transformed_inputs.get(1);
