 ...
 * 
 */
public class TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_GTTest {

	// private final static Logger logger  = Logger.getLogger(TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_GTTest.class.getName());
	...
	public void setUp() throws PluginException, ModelException {
		...
		workflowMockEnvironment.setModelPath("/bpmn/TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_GTTest.bpmn");
		...
		// logger.info("[TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_GTTest] setup test data...");
...
// // 
	...
	public void testCreateSubProcessCopyItemByRegex_IT() throws ModelException {
		String itemName1 = "$workitemref";
		ItemCollection documentContext = this.documentContext; documentContext.replaceItemValue("$workitemref", "11112222"); documentContext.replaceItemValue("txtworkitemref", "11112222");
		String itemName2 = TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_GT.inputTransformation_testCreateSubProcessCopyItemByRegex(documentContext, itemName1);
