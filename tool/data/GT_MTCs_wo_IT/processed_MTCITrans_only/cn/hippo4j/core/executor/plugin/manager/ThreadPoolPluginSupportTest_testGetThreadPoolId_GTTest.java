 ...
 */
public class ThreadPoolPluginSupportTest_testGetThreadPoolId_GTTest {

    private static ThreadPoolPluginManager manager = new DefaultThreadPoolPluginManager();
    private ExtensibleThreadPoolExecutor executor = new ExtensibleThreadPoolExecutor(
            "test", manager,
...
//     @Test
//     public void testGetThreadPoolId_h() {
...
// 
    @Test
    public void testGetThreadPoolId_IT() {
        ExtensibleThreadPoolExecutor executor = new ExtensibleThreadPoolExecutor(
            "test", manager,
            5, 5, 1000L, TimeUnit.MILLISECONDS,
            new ArrayBlockingQueue<>(1), Thread::new, new ThreadPoolExecutor.AbortPolicy());
        ThreadPoolPluginSupport support = ThreadPoolPluginSupportTest_testGetThreadPoolId_GT.inputTransformation_testGetThreadPoolId(executor);
        Assert.assertEquals(executor.getThreadPoolId(), support.getThreadPoolId());
    }
