...
class RandomUuidGeneratorTest_generates_different_non_null_uuids_GT {
    @Test
    ...
    void generates_different_non_null_uuids_IT() {
        // Given
        UuidGenerator generator = new RandomUuidGenerator();
        UuidGenerator generator2 = inputTransformation_generates_different_non_null_uuids(generator);
        UUID uuid1 = generator.generateId();
