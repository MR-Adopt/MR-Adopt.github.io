...
@DaoSqlTest
public class DeviceCredentialsServiceTest_testFindDeviceCredentialsByCredentialsId_GT extends AbstractServiceTest {
...
// 
//         Assert.assertEquals(savedDevice.getId(), deviceCredentials.getDeviceId());
//         String id = inputTransformation_testFindDeviceCredentialsByCredentialsId(tenantId, savedDevice);
