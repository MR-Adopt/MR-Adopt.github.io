...
class RandomUuidGeneratorTest_generates_different_non_null_uuids_GTTest {
//     @Test
...
// // 
    ...
    void generates_different_non_null_uuids_IT() {
        // Given
        UuidGenerator generator = new RandomUuidGenerator();
        UuidGenerator generator2 = RandomUuidGeneratorTest_generates_different_non_null_uuids_GT.inputTransformation_generates_different_non_null_uuids(generator);
        UUID uuid1 = generator.generateId();
