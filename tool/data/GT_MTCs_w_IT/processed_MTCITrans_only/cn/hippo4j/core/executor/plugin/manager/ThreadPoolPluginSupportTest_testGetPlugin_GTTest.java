 ...
 */
public class ThreadPoolPluginSupportTest_testGetPlugin_GTTest {
...
// 
    @Test
    public void testGetPlugin_IT() {
        ThreadPoolPlugin plugin = new TestExecuteAwarePlugin();
        support.register(plugin);
        String input2 = ThreadPoolPluginSupportTest_testGetPlugin_GT.inputTransformation_testGetPlugin(plugin);
        Assert.assertSame(plugin, support.getPlugin(input2).orElse(null));
    }
