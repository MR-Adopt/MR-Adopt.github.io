 ...
 */
public class ThreadPoolPluginSupportTest_testGetPluginTest {
...
// 
    ...
    public void testGetPlugin_IT() {
        ThreadPoolPlugin plugin = new TestExecuteAwarePlugin();
        support.register(plugin);
        String input2 = ThreadPoolPluginSupportTest_testGetPlugin.inputTransformation_testGetPlugin(plugin);
