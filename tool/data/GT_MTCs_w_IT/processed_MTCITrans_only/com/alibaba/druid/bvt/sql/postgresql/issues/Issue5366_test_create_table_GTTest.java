 ...
 */
public class Issue5366_test_create_table_GTTest {

//     @Test
//     public void test_create_table_h() throws Exception {
...
// // 
    @Test
    public void test_create_table_IT() throws Exception {
        DbType dbType = DbType.postgresql;
        String sql = "CREATE TABLE orders_p4 PARTITION OF orders\n"
            + "    FOR VALUES WITH (MODULUS 4, REMAINDER 3);";
        ...
        String newSql = Issue5366_test_create_table_GT.inputTransformation_test_create_table(sql);
        String normalizeNewSql = normalizeSql(newSql);
        assertEquals(normalizeSql.toLowerCase(),normalizeNewSql.toLowerCase());
