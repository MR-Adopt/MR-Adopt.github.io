...
public class Base64DoubleUrlEncodeSafeTest_testEncodeAndDecodeTest {
...
// 
	...
	public void testEncodeAndDecode_IT() throws java.io.UnsupportedEncodingException {
		String input = "Hello, Base64DoubleUrlEncodeSafe!";
		String encoded = Base64DoubleUrlEncodeSafe.encode(input);
		String encoded2 = Base64DoubleUrlEncodeSafeTest_testEncodeAndDecode.inputTransformation_testEncodeAndDecode(input); // 这个class name 可能不太行。
		String decoded = Base64DoubleUrlEncodeSafe.decode(encoded2);
		assertEquals("Decoding did not produce the original string for input: " + input, input, decoded);
