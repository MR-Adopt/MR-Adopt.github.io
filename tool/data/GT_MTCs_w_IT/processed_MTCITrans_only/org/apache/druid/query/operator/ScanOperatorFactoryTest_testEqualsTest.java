...
public class ScanOperatorFactoryTest_testEqualsTest
{
  static {
...
//   {
//     ScanOperatorFactoryTest_testEqualsTest.Builder bob = new ScanOperatorFactoryTest_testEqualsTest.Builder();
...
//     ScanOperatorFactoryTest_testEqualsTest.Builder bob2 = (ScanOperatorFactoryTest_testEqualsTest.Builder) new ScanOperatorFactoryTest_testEqualsTest.Builder();
...
// 
// 
// //   public static ScanOperatorFactoryTest_testEqualsTest.Builder inputTransformation_testEquals(ScanOperatorFactoryTest_testEqualsTest.Builder bob) {
// //     ScanOperatorFactoryTest_testEqualsTest.Builder bob2 = bob.copy();
...
// // 
  ...
  public void testEquals_IT()
  {
    ...
    bob.ordering = Collections.singletonList(ColumnWithDirection.ascending("a"));
    ScanOperatorFactory factory = bob.build();
    ScanOperatorFactoryTest_testEqualsTest.Builder bob2 = (ScanOperatorFactoryTest_testEqualsTest.Builder) ScanOperatorFactoryTest_testEquals.inputTransformation_testEquals(bob);
    Assert.assertNotEquals(factory, bob2.build());
