...
public class InFlightRequestFutureTest_testInFlightRequestKey_GTTest {

//     @Test
//     public void testInFlightRequestKey_h() {
...
// 
    @Test
    public void testInFlightRequestKey_IT() {
        InFlightRequestKey requestKey1 = new InFlightRequestKey("group", 0, 0);
        InFlightRequestKey requestKey2 = InFlightRequestFutureTest_testInFlightRequestKey_GT.inputTransformation_testInFlightRequestKey(requestKey1);
        Assert.assertEquals(requestKey1, requestKey2);
        Assert.assertEquals(requestKey1.hashCode(), requestKey2.hashCode());
        Assert.assertEquals(requestKey1.getGroup(), requestKey2.getGroup());
        Assert.assertNotEquals(requestKey1.getOffset(), requestKey2.getOffset());
...
//         InFlightRequestKey requestKey2 = new InFlightRequestKey(requestKey1.getGroup(), requestKey1.getOffset()+1, requestKey1.getBatchSize()+2);
//         return requestKey2;
//     }
// 
}