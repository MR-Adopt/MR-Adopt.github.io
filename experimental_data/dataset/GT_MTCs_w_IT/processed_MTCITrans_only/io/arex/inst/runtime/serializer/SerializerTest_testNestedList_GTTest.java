...
class SerializerTest_testNestedList_GTTest {
    @BeforeAll
    static void setUp() {
...
// // 
    ...
    void testNestedList_IT() {
        ...
        List<Object> transformed_inputs = SerializerTest_testNestedList_GT.inputTransformation_testNestedList(list, serializer);
