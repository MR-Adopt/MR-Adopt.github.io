...
class SerializerTest_testNestedSet_GTTest {
    @BeforeAll
    static void setUp() {
...
// // 
    ...
    void testNestedSet_IT() {
        ...
        List<Object> transformed_inputs = SerializerTest_testNestedSet_GT.inputTransformation_testNestedSet(set, serializer);
