 ...
 */
public class Issue5430_test_createTable_GTTest {

    // private static final Log log = LogFactory.getLog(Issue5430_test_createTable_GTTest.class);

//     @Test
//     public void test_createTable_h() throws Exception {
...
// // 
    @Test
    public void test_createTable_IT() throws Exception {
        DbType dbType = DbType.hive;
        int index = 0;
        String sql = "CREATE TABLE my_table(a string, b bigint)\n"
            + "ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.JsonSerDe'\n"
        ...
        String newSql = Issue5430_test_createTable_GT.inputTransformation_test_createTable(sql);
        String normalizeNewSql = normalizeSql(newSql);
        System.out.println("第" + index + "条生成的sql格式归一化===" + normalizeNewSql);
