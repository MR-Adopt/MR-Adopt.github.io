...
public class PlayfairTest_testEncryptionAndDecryption_GTTest {
...
// // 
    ...
    public void testEncryptionAndDecryption_IT() {
        ...
        String encryptedText = playfairCipher.encrypt(plaintext);
        assertEquals("SHHAHRFB", encryptedText);
        String textTodecrypt = PlayfairTest_testEncryptionAndDecryption_GT.inputTransformation_testEncryptionAndDecryption(playfairCipher, plaintext);
        String decryptedText = playfairCipher.decrypt(textTodecrypt);
