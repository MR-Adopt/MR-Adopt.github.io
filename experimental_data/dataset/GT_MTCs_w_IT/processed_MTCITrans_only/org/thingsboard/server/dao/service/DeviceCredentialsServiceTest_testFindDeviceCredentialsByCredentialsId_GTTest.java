...
@DaoSqlTest
public class DeviceCredentialsServiceTest_testFindDeviceCredentialsByCredentialsId_GTTest extends AbstractServiceTest {
...
// // 
    ...
    public void testFindDeviceCredentialsByCredentialsId_IT() {
        ...
        Assert.assertEquals(savedDevice.getId(), deviceCredentials.getDeviceId());
        String id = DeviceCredentialsServiceTest_testFindDeviceCredentialsByCredentialsId_GT.inputTransformation_testFindDeviceCredentialsByCredentialsId(tenantId, savedDevice);
