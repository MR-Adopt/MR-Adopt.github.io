...
public class CloseableResourceHolderTest_testCloseableResourceHolder_GTTest
{
//   @Test
//   public void testCloseableResourceHolder_h()
//   {
...
// //   
  @Test
  public void testCloseableResourceHolder_IT()
  {
    AtomicLong closeCounter = new AtomicLong();
    Closeable closeable = closeCounter::incrementAndGet;
    ResourceHolder<Closeable> holder = ResourceHolder.fromCloseable(closeable);
    ResourceHolder<Closeable> holder2 = CloseableResourceHolderTest_testCloseableResourceHolder_GT.inputTransformation_testCloseableResourceHolder(closeable);
