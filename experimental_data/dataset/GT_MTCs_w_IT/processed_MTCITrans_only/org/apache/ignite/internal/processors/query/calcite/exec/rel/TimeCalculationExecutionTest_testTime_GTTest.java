 ...
 */
public class TimeCalculationExecutionTest_testTime_GTTest extends AbstractExecutionTest {
    /** */
//     @Test
...
//         RootNode<Object[]> rootNode2 = new RootNode<>(ctx, rowType);
//         SourceNode srcNode2 = new SourceNode(ctx, rowType);
//         rootNode2.register(srcNode2);
// 
//         assertEquals(execTime3, rootNode.execTime());
//         assertEquals(idleTime3, rootNode2.idleTime());
//     }
// 
// //     public static RootNode<Object[]> inputTransformation_testTime(RootNode<Object[]> rootNode) {
// //         RootNode<Object[]> rootNode2 = new RootNode<>(rootNode);
// //         return rootNode2;
// //     }
// // 
    @Test
    public void testTime_IT() throws Exception {
        long sleepTime = 200;
        ...
        long execTime3 = rootNode.execTime();
        long idleTime3 = rootNode.idleTime();
        RootNode<Object[]> rootNode2 = TimeCalculationExecutionTest_testTime_GT.inputTransformation_testTime(rootNode);
