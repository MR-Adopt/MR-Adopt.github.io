 ...
 */
public class Issue5430_test_createTable_GT {

    // private static final Log log = LogFactory.getLog(Issue5430_test_createTable.class);
    ...
    public void test_createTable_IT() throws Exception {
        ...
        String newSql = inputTransformation_test_createTable(sql);
        String normalizeNewSql = normalizeSql(newSql);
        System.out.println("第" + index + "条生成的sql格式归一化===" + normalizeNewSql);
