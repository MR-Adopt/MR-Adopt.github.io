...
public class ScanOperatorFactoryTest_testEquals_GT
{
  static {
  ...
  {
    ScanOperatorFactoryTest_testEquals.Builder bob = new ScanOperatorFactoryTest_testEquals.Builder();
    ...
    ScanOperatorFactoryTest_testEquals.Builder bob2 = (ScanOperatorFactoryTest_testEquals.Builder) new ScanOperatorFactoryTest_testEquals.Builder();
  ...
  public static ScanOperatorFactoryTest_testEquals.Builder inputTransformation_testEquals(ScanOperatorFactoryTest_testEquals.Builder bob) {
    ScanOperatorFactoryTest_testEquals.Builder bob2 = bob.copy();
  ...
  public void testEquals_IT()
  {
    ...
    bob.ordering = Collections.singletonList(ColumnWithDirection.ascending("a"));
    ScanOperatorFactory factory = bob.build();
    ScanOperatorFactoryTest_testEquals.Builder bob2 = (ScanOperatorFactoryTest_testEquals.Builder) inputTransformation_testEquals(bob);
    Assert.assertNotEquals(factory, bob2.build());
