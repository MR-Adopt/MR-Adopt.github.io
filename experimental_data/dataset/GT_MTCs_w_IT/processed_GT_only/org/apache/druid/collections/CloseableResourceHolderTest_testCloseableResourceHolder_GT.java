...
public class CloseableResourceHolderTest_testCloseableResourceHolder_GT
{
  @Test
  ...
  public void testCloseableResourceHolder_IT()
  {
    ...
    Closeable closeable = closeCounter::incrementAndGet;
    ResourceHolder<Closeable> holder = ResourceHolder.fromCloseable(closeable);
    ResourceHolder<Closeable> holder2 = inputTransformation_testCloseableResourceHolder(closeable);
