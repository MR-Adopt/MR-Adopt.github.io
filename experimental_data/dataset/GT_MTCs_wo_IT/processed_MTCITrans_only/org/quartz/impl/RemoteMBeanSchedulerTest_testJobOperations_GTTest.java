...
/**
 * RemoteMBeanSchedulerTest_testJobOperations_GTTest
 */
public class RemoteMBeanSchedulerTest_testJobOperations_GTTest {
...
//     @Test
//     public void testJobOperations_h() throws Exception {
...
// //         JobKey jobkey = job2Detail.getKey();
// //         return jobkey;
// //     }
// // 
// // 
    @Test
    public void testJobOperations_IT() throws Exception {
        JobDetail job2Detail = newJob(HelloJob.class).withIdentity(new JobKey("job2", GROUP_KEY)).storeDurably().build();

        remoteScheduler.addJob(job2Detail, false);

        JobKey job22 = RemoteMBeanSchedulerTest_testJobOperations_GT.inputTransformation_testJobOperations(job2Detail);
