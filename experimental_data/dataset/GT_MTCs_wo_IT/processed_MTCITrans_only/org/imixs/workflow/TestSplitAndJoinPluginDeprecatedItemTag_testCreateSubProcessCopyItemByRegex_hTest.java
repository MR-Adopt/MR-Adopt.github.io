 ...
 * 
 */
public class TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_hTest {

	// private final static Logger logger  = Logger.getLogger(TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_hTest.class.getName());
	...
	public void setUp() throws PluginException, ModelException {
		...
		workflowMockEnvironment.setModelPath("/bpmn/TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_hTest.bpmn");
		...
		// logger.info("[TestSplitAndJoinPluginDeprecatedItemTag_testCreateSubProcessCopyItemByRegex_hTest] setup test data...");
