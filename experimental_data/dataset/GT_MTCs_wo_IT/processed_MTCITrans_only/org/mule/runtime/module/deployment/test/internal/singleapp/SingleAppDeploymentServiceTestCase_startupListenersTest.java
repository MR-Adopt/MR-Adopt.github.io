...
public class SingleAppDeploymentServiceTestCase_startupListenersTest extends AbstractMuleTestCase {
...
// // 
  ...
  public void startupListeners_IT() {
    ...
    StartupListener startUpListener1 = mock(StartupListener.class);
    StartupListener startUpListener2 = SingleAppDeploymentServiceTestCase_startupListeners.inputTransformation_startupListeners(startUpListener1);
    singleAppDeploymentService.addStartupListener(startUpListener1);
    singleAppDeploymentService.addStartupListener(startUpListener2);
