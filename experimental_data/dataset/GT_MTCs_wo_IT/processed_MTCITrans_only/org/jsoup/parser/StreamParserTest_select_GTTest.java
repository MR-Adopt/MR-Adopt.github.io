 ...
 */
class StreamParserTest_select_GTTest {
...
//     @Test void select_h() throws IOException {
...
// //         String queryTitle2 = parser.expectFirst(queryTitle).tagName();
// //         return queryTitle2;
// //     }
// // 
    @Test void select_IT() throws IOException {
        StreamParser parser = new StreamParser(Parser.htmlParser()).parse("<title>One</title><p id=1>P One</p><p id=2>P Two</p>", "");
        String queryTitle = "title";
        ...
        String queryTitle2 = StreamParserTest_select_GT.inputTransformation_select(parser, queryTitle);
        Element title2 = parser.selectFirst(queryTitle2);
        assertSame(title2, title);
