...
@SmallTest
public class ArtifactAwareContextSelectorTestCase_returnsParentContextForPolicyClassloader_GT extends AbstractMuleTestCase {
  ...
  public void returnsParentContextForPolicyClassloader_IT() {
    ...
    List<Object> transformed_inputs = inputTransformation_returnsParentContextForPolicyClassloader(fqcn, currentContext, childClassLoader);
